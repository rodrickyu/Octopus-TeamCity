...
public class OctopusReleaseController extends BaseController {
    @NotNull
    private final PluginDescriptor myDescriptor;

    public OctopusReleaseController(@NotNull final PluginDescriptor descriptor,
                                    @NotNull final OctopusReleasePaths paths,
